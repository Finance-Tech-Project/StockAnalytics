...
public class PortfolioServiceImpl implements PortfolioService {
  ...
  public void addToWatchList(String userName, String symbol) throws InterruptedException {
    ...
    if (newSymbol == null) {
      logger.info("The symbol is not found in the repository: {}", symbol);
    ...
    if (!watchlist.contains(symbol)) {
      ...
      logger.info("Symbol has been successfully added to the watch list: {}", symbol);
    } else {
      logger.error("The symbol '{}' already exists in the watch list.", symbol);
    }
  }
